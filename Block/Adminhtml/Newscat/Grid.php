...
namespace Acme\FahimNews\Block\Adminhtml\Newscat;
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'frame_callback' => [
                    $this->getLayout()
                        ->createBlock(
                            \Acme\FahimNews\Block\Adminhtml\Grid\Column\Statuses::Class
                        ),
                    'decorateStatus'
                ],
            ]
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'cat_parent',
                'renderer' => \Acme\FahimNews\Block\Adminhtml\Newscat\Grid\Renderer\Catname::Class,
                'class' => 'xxx',
                'width' => '50px',
            ]
        );
