...
namespace Acme\FahimNews\Block\Adminhtml\Newspost;

use Acme\FahimNews\Model\NewspostFactory;
use Acme\FahimNews\Model\Status;
...
/**
 * Class Grid
 * @package Acme\FahimNews\Block\Adminhtml\Newspost
 */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'class' => 'xxx',
                'width' => '50px',
                'renderer'  => 'Acme\FahimNews\Block\Adminhtml\Newspost\Renderer\PublishDate',
            ]
        );
        $this->addColumn(
            'is_active',
            [
                ...
                'frame_callback' => [
                    $this->getLayout()
                        ->createBlock(
                            'Acme\FahimNews\Block\Adminhtml\Grid\Column\Statuses'
                        ),
                    'decorateStatus'
                ],
            ]
