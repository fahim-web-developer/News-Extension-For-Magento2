...
namespace Acme\FahimNews\Block;

use Acme\FahimNews\Helper\Data;
use Acme\FahimNews\Model\Categories;
...
class PostView extends Template
{
    ...
    {
        return $this->getViewFileUrl('Acme_FahimNews::images/views.png');
    }
