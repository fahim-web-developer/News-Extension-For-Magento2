...
namespace Acme\FahimNews\Helper;

use Acme\FahimNews\Model\Newspost;
...
class Data extends AbstractHelper
{
     ...
     *
     */
    const XML_PATH_ITEMS_PER_PAGE = 'acme_fahimnews/general/postonlist';
    /**
     *
     */
    const XML_PATH_POST_SORT_ORDER = 'acme_fahimnews/general/post_sorting';
    /**
     *
     */
    const XML_PATH_LIST_PAGE_LAYOUT = 'acme_fahimnews/general/post_list_layout';
    /**
     *
     */
    const XML_PATH_COMMENTS_PER_PAGE = 'acme_fahimnews/comments/commentcount';
    /**
     *
     */
    const XML_PATH_RELATED_POST_DISPLAY =
        'acme_fahimnews/related_setting/related_posts/enabled';
    /**
     *
     */
    const XML_PATH_RELATED_POST_NUMBER =
        'acme_fahimnews/related_setting/related_posts/number_of_posts';
    /**
     *
     */
    const XML_PATH_RELATED_PRODUCT_DISPLAY =
        'acme_fahimnews/related_setting/related_products/enabled';
    /**
     *
     */
    const XML_PATH_RELATED_PRODUCT_NUMBER =
        'acme_fahimnews/related_setting/related_products/number_of_products';
    /**
     *
     */
    const XML_PATH_RELATED_SHOW_CART =
        'acme_fahimnews/related_setting/related_products/show_addtocart';
    /**
     *
     */
    const XML_PATH_RELATED_SHOW_WISHLIST =
        'acme_fahimnews/related_setting/related_products/show_whishlist_icon';
    /**
     *
     */
    const XML_PATH_RELATED_SHOW_COMPARE =
        'acme_fahimnews/related_setting/related_products/show_compare_icon';

    /**
     *
     */
    const MEDIA_PATH = 'acme/fahimnews/image/';
     ...
     *
     */
    const XML_PATH_SITEMAP = 'fahimnews/sitemap/show';
    ...
    {
        return $this->getStoreConfig('acme_fahimnews/general/active');
    }
    ...
    public function getUrlByPost($post)
    {
        $urlKey = '';
        if ($post->getUrlKey()) {
            $urlPrefix = $this->getStoreConfig('acme_fahimnews/general/url_prefix');
            $urlSuffix = $this->getStoreConfig('acme_fahimnews/general/url_suffix');
    ...
    {
        $catPrefix = $this->getStoreConfig('acme_fahimnews/general/cat_prefix');
        $urlSuffixConfig = $this->getStoreConfig('acme_fahimnews/general/url_suffix');
        $urlSuffix = "";
