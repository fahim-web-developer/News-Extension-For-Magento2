...
class Newspost extends AbstractModel
{
    ...
    {
        $this->_init('Acme\FahimNews\Model\ResourceModel\Newspost');
    }
    ...
    public function getPostUrl()
    {
        $newsTitle = $this->_dataHelper
            ->getStoreConfig('acme_fahimnews/general/url_prefix');
        $urlSuffixConfig = $this->_dataHelper
            ->getStoreConfig('acme_fahimnews/general/url_suffix');
        $urlSuffix = "";
    ...
    public function getDisplayViews()
    {
        return $this->_dataHelper
            ->getStoreConfig('acme_fahimnews/display_settings/display_views');
    }
    ...
    {
        return $this->_dataHelper
            ->getStoreConfig('acme_fahimnews/display_settings/display_share');
    }
    ...
    {
        return $this->_dataHelper
            ->getStoreConfig('acme_fahimnews/display_settings/share_above');
    }
    ...
    {
        return $this->_dataHelper
            ->getStoreConfig('acme_fahimnews/display_settings/share_below');
    }
    ...
    {
        return $this->_dataHelper
            ->getStoreConfig('acme_fahimnews/display_settings/display_tags');
    }
    ...
    public function getRelatedPosts()
    {
        ...
        $collection->getSelect()->joinLeft(
            [
                're' => $this->getResource()
                    ->getTable('acme_fahimnews_post_relatedpost')
            ],
    ...
    public function getRelatedProducts()
    {
        ...
        $collection->getSelect()->joinLeft(
            [
                're' => $this->getResource()
                    ->getTable('acme_fahimnews_post_relatedproduct')
            ],
